...
> I'm currently developing a method that uses LUA scripting so it logs to both Telemetry and .bin files (see [serial_script](https://github.com/PatrickMeerssche/stm32-current-pixhawk/tree/serial_script)).
