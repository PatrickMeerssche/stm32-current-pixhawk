...
const float CURRENT_GAIN_CAL = -11.23f; // Fine-trimmed from Fluke points: 1.26/1.15 and 1.50/1.33.
const float OFFSET_DC_DEFAULT = 731.72f;      // Fixed zero-current ADC offset from latest confirmed 0.00A samples.
